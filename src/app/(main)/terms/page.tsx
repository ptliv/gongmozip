    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 space-y-10">
      ...
      <Article num={2} title="서비스 내용">
        ...
        <ul>
          ...
          <li>공고 상세 페이지 및 지원 준비 가이드 제공</li>
        </ul>
        <p>
          서비스에서 제공되는 공고 정보는 공개된 모집 정보를 수집·가공한 것으로, 공고 기관이
          변경하거나 삭제한 정보가 즉시 반영되지 않을 수 있습니다. 중요한 사항은 최신 모집 요강을 기준으로 확인하시기 바랍니다.
        </p>
      </Article>
      ...
      <Article num={4} title="지식재산권">
        <p>
          ...
          각 모집 공고와 이미지 등에 대한 권리는 해당 권리자에게 귀속됩니다.
