...
const FAQ = [
  {
    q: "공모전 정보는 어떻게 수집되나요?",
    a: "공개된 모집 정보를 수집·정리하고, 일정·대상·혜택·지원 준비 내용을 공모전집 기준으로 재구성해 제공합니다.",
  },
  {
  ...
  {
    q: "참가 신청은 어떻게 하나요?",
    a: "공모전집은 공고 탐색과 준비를 돕는 플랫폼입니다. 실제 접수 전에는 최신 모집 요강의 접수 조건과 제출 방식을 확인해 주세요.",
  },
  {
      ...
      <section className="rounded-2xl border border-yellow-200 bg-yellow-50/50 p-7 space-y-5">
        ...
        <div className="pt-1 space-y-3">
          ...
          <p className="text-xs text-gray-400">
            ※ 참가 신청 전 최신 모집 요강과 접수 조건을 확인해 주세요.
          </p>
        </div>
      </section>
